          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="">
                <div class="service1-box">
                  <div class="service1-icon">
                    <img src="assets/img/icons/service2-icon7.svg" alt="">
                  </div>
                  <div class="space24"></div>
                  <div class="hadding2">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="">
                <div class="service1-box">
                  <div class="service1-icon">
                    <img src="assets/img/icons/service2-icon8.svg" alt="">
                  </div>
                  <div class="space24"></div>
                  <div class="hadding2">
            ...
            <div class="choose2 sp3 _relative" style="background-color: #F2F5F5;">
                <div class="container">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                      <div class="choose2-main-image">
                        <div class="choose2-image img50" >
                          <img src="assets/img/image/choose2-main-image.png" alt="">
                        </div>
